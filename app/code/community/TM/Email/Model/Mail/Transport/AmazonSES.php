 ...
 */
class TM_Email_Model_Mail_Transport_AmazonSES extends Zend_Mail_Transport_Abstract
{
    /**
     ...
     * @var string
     */
    protected $bodyRequestTemplate = 'Action=SendRawEmail&Source=%s&%s&RawMessage.Data=%s';
    ...
    public function __construct(Array $config = array(), $host = 'https://email.us-east-1.amazonaws.com')
    {
        ...
        $this->host = Zend_Uri::factory($host);
    }
    ...
    public function _sendMail()
    {
        ...
        //Send the request
        $client = new Zend_Http_Client($this->host);

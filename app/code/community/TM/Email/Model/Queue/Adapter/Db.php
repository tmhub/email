...
/**
 *  Overrided Zend_Queue_Adapter_Db
 */

class TM_Email_Model_Queue_Adapter_Db extends Zend_Queue_Adapter_AdapterAbstract
{
    /**
     * @var TM_Email_Model_Queue_Adapter_Db_Queue
     */
    protected $_queueTable = null;

    /**
     * @var TM_Email_Model_Queue_Adapter_Db_Message
     */
    ...
    public function create($name, $timeout = null)
    {
        ...
        $queue->default_status = TM_Email_Model_Queue_Message_Status::APPROVED;
    ...
    public function count(Zend_Queue $queue = null)
    {
        ...
        $query->from($info['name'], array(new Zend_Db_Expr('COUNT(1)')))
              ...
              ->where('status = ?', TM_Email_Model_Queue_Message_Status::APPROVED)
            ;
